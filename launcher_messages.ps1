...
$messages = @{
  ...
  install_success = "Установка завершена. Qt default: run_app.bat/launcher.bat. Legacy fallback: run_legacy.bat."
  ...
  app_failed = "Legacy приложение завершилось с кодом: $env:LAUNCHER_APP_EXIT"
