...
def test_v2_storage_contains_owned_action_recon_asteroid_and_debris_state() -> None:
    ...
    debris_candidates = text("v2/persistence/debris_candidates.py")
    ...
    assert "debris_observations" in debris_candidates
